...
from quant.v9_v1_contract import HORIZONS, HORIZON_SECONDS, V1Input
...
def synthesize_v3(v1: V1Input, v2: V2EvidenceState) -> V3Output:
    ...
    evidence_compatible = (v1.evidence_state_id == v2.state_id and
                           v1.evidence_state_version == v2.state_version and
                           v1.evidence_state_hash == v2.state_hash)
    ...
    for horizon in HORIZONS:
        ...
        eligible = tuple(q for q in CANONICAL_FAMILIES
                         ...
                         slots[q].availability_state == "FRESH" and
                         slots[q].formula_version == calibrations[q].formula_version and
                         slots[q].value_bps is not None and calibrations[q].status != "UNAVAILABLE")
        if not eligible:
