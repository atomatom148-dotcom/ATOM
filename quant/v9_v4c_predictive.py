...
class V4CStateStore:
    ...
    def latest_json(self,*,symbol:str,cohort_id:str,requested_cutoff:datetime):
        ...
        cursor.execute("SELECT state_hash,state_json,state_as_of,evidence_last_cutoff FROM atom_v9_v4_states WHERE state_version=%s AND model_version=%s AND symbol=%s AND cohort_id=%s AND state_as_of<=%s ORDER BY state_as_of DESC",
        ...
        state_hash,state_json,state_as_of,last=tied[0]
